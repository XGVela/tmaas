...
import org.xgvela.cnf.model.RegisterRequest;
...
public class RegisterTask {
	...
	private static void setRegisterRequestEntity() {
		try {
			entity = new HttpEntity<String>(TopoManager.mapper
					.writeValueAsString(new RegisterRequest(NatsAppender.TopoEngine, NatsAppender.K8sContainer)));
